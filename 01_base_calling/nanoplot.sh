...
INPUT_FASTQ=/nfs/scratch/sanghu/johndory/chap2_ref_genome/01_base_calling/duplex_calling/fastq/merged.simplex.fastq.gz
OUT_DIR=/nfs/scratch/sanghu/johndory/chap2_ref_genome/01_base_calling/duplex_calling/fastq/nanoplot/simplex
...
NanoPlot -t 40 --N50 --dpi 300 --fastq $INPUT_FASTQ --loglength -o $OUT_DIR --plots kde hex dot
